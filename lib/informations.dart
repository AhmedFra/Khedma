          ...
          child: Column(
            ...
            children: [
              Text("Add Meddcine",style: TextStyle(
                            ...
                            color: Colors.black)),
              Muinput(title:"First Name" ,hint:"Enter your First name " ,controller: _titleController,),
              Muinput(title:"Last name" ,hint:"Enter your Last name" ,controller: _noteController,),
